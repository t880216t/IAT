export default {
  ...
  'menu.product':'商品管理',
  'menu.home.index':'监控概况',
  'menu.order.index':'订单列表',
  'menu.order':'订单管理',
  'menu.product.productList':'商品',
  'menu.product.tools':'快捷工具',
  'menu.users.index':'用户列表',
  'menu.users':'用户管理',
  'menu.system':'系统管理',
  'menu.system.index':'系统信息',
  'menu.system.project':'项目管理',
  'menu.product.class':'分类管理',
  'menu.product.productList.list':'商品列表',
  'menu.product.productList.detail':'商品详情',
  'menu.product.productList.add':'新增商品',
